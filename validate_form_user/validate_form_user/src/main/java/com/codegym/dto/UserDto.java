...
public class UserDto {
    ...
    @NotNull
    @Size(min = 2, max = 45,message = "First name bắt buộc, có độ dài tối thiểu 5, tối đa 45 ký tự")
    private String firstName;

    @NotBlank
    @Size(min = 2, max = 45,message = "Last name bắt buộc, có độ dài tối thiểu 5, tối đa 45 ký tự")
